...
<head>
    ...
    =====================================
    <link rel="stylesheet" href="{{ asset('assets/css/icon/linea-arrows-10.css')}}">
    <link rel="stylesheet" href="{{ asset('assets/css/icon/linea-basic-10.css')}}">
    <link rel="stylesheet" href="{{ asset('assets/css/icon/linea-basic-elaboration-10.css')}}">
    <link rel="stylesheet" href="{{ asset('assets/css/icon/linea-ecommerce-10.css')}}">
    <link rel="stylesheet" href="{{ asset('assets/css/icon/linea-music-10.css')}}">
    <link rel="stylesheet" href="{{ asset('assets/css/icon/linea-software-10.css')}}">
    <link rel="stylesheet" href="{{ asset('assets/css/icon/linea-weather-10.css')}}">-->
